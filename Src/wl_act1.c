...
void CloseDoor(int door)
{
	...
	//
	area = *(mapsegs[0] + farmapylookup[doorobjlist[door].tiley] + doorobjlist[door].tilex) - AREATILE;
...
void DoorOpening(int door)
{
	...
	if (!position)
	{
		...
		//
		map = (word *)(mapsegs[0] + farmapylookup[doorobjlist[door].tiley] + doorobjlist[door].tilex);
...
void DoorClosing(int door)
{
	...
	if ((actorat[tilex][tiley] != (door | 0x80)) || (player->tilex == tilex && player->tiley == tiley))
